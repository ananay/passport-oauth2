...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  if (req.body && req.body.error) {
    if (req.body.error == 'access_denied') {
      return this.fail({ message: req.body.error_description });
    } else {
      return this.error(new AuthorizationError(req.body.error_description, req.body.error, req.body.error_uri));
    }
  }
